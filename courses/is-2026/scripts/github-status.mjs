...
const base='https://api.github.com/repos/OlgaKraven/2026-demo-template';
const endpoint=process.argv[2]||'';
const method=process.argv[3]||'GET';
if(!['','/pages','/actions/runs','/actions/workflows/course-pages.yml/dispatches'].includes(endpoint))throw Error('Unsupported endpoint');
